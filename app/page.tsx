...
import ResultsPage from "./components/ResultsPage";"use client";
import { useState } from "react";
import { AnimatePresence } from "framer-motion";

// Absolute path routing to prevent Vercel deployment path resolution crashes
import InputPage from "@/components/InputPage";
import LoadingPage from "@/components/LoadingPage";
...
const FLAGS: Record<string, string> = {
  ...
  Australia: "🇦🇺", Canada: "🇨🇦", Singapore: "🇸🇬", UAE: "🇦🇪", Japan: "🇯🇵",
  Brazil: "🇧🇷", "South Africa": "🇿🇦", Netherlands: "🇳🇱", Nigeria: "🇳🇬", Kenya: "🇰🇪"
};
...
export default function Home() {
  ...
  const [cIdea, setCIdea] = useState(""); 
  const [cCap, setCCap] = useState(""); 
  const [cCountry, setCCountry] = useState("India"); 
  const [cMarket, setCMarket] = useState("domestic");
